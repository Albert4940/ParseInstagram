...
import com.albert.parseinstagram.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btnImage = view.findViewById(R.id.btnCaptureImage);
        ivPoster = view.findViewById(R.id.ivPosterImage);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photoFile==null || ivPoster.getDrawable()==null)
                {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                ivPoster.setImageBitmap(takenImage);
